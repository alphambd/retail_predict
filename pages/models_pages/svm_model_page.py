...
def show():
    ...
    if st.button('Lancer la prévision avec SVM'):
        with st.spinner('Entraînement et prédiction en cours...'):
            forecast_df, metrics, fig = run_svm_forecast(df, granularity, target_id, val_start, test_start)
