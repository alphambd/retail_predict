...
def show():
    ...
    if st.button('Lancer la prévision avec DeepAR'):
        with st.spinner('Entraînement et prédiction en cours (cela peut prendre quelques minutes)...'):
            forecast_df, metrics, fig = run_deepar_forecast(df, granularity, target_id, val_start, test_start)
